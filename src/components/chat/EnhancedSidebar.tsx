...
export default function EnhancedSidebar({ 
  ...
  return (
    <div className="flex flex-col h-full bg-white relative w-full shadow-sm">
      ...
      {/* Sliding Menu */}
      <div 
        className={`fixed left-0 top-0 h-full bg-white shadow-lg transition-transform z-50 ${
...
function ConversationItem({ 
  ...
  return (
    <button
      className={`w-full p-3 text-left hover:bg-gray-50 transition-all duration-200 border-none bg-transparent group ${
      ...
      <div className="flex items-center">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-start mb-1">
            <div className="flex items-center truncate pr-2 flex-1">
              <span className={`font-semibold truncate ${
                conversation.unread ? 'text-gray-900' : 'text-gray-800'
              }`}>
                {conversation.name}
              </span>
          ...
          <div className="flex justify-between items-center">
            {/* Last Message */}
            <p className={`text-sm mb-0 truncate pr-2 flex-1 ${
